...
### (Generated on 2019-12-27 05:53:56.169712) ###
...
class GetStats(base_classes.Baserequests):
...
class BroadcastCustomMessage(base_classes.Baserequests):
...
class GetVideoInfo(base_classes.Baserequests):
...
class ListOutputs(base_classes.Baserequests):
...
class GetOutputInfo(base_classes.Baserequests):
...
class StartOutput(base_classes.Baserequests):
    """Start an output
...
class StopOutput(base_classes.Baserequests):
    """Stop an output
...
class PauseRecording(base_classes.Baserequests):
...
class ResumeRecording(base_classes.Baserequests):
...
class ReorderSceneItems(base_classes.Baserequests):
...
class GetSourceTypesList(base_classes.Baserequests):
...
class GetSourceFilterInfo(base_classes.Baserequests):
    """List filters applied to a source
...
class SetSourceFilterVisibility(base_classes.Baserequests):
...
class TakeSourceScreenshot(base_classes.Baserequests):
    """
...
class SendCaptions(base_classes.Baserequests):
