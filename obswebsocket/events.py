...
### (Generated on 2019-12-27 05:53:56.174363) ###
...
class RecordingPaused(base_classes.Baseevents):
...
class RecordingResumed(base_classes.Baseevents):
...
class BroadcastCustomMessage(base_classes.Baseevents):
...
class SourceCreated(base_classes.Baseevents):
...
class SourceDestroyed(base_classes.Baseevents):
...
class SourceVolumeChanged(base_classes.Baseevents):
...
class SourceMuteStateChanged(base_classes.Baseevents):
...
class SourceAudioSyncOffsetChanged(base_classes.Baseevents):
...
class SourceAudioMixersChanged(base_classes.Baseevents):
...
class SourceRenamed(base_classes.Baseevents):
...
class SourceFilterAdded(base_classes.Baseevents):
...
class SourceFilterRemoved(base_classes.Baseevents):
...
class SourceFilterVisibilityChanged(base_classes.Baseevents):
...
class SourceFiltersReordered(base_classes.Baseevents):
...
class SceneItemSelected(base_classes.Baseevents):
...
class SceneItemDeselected(base_classes.Baseevents):
